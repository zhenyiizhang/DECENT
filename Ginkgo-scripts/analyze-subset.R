...
# --
setwd(paste('/lustre/home/2301110060/ginkgo-master/uploads/', userID, sep=''))
maxPloidy = 6
...
normal2 = normal
#
GC = read.table(paste("/lustre/home/2301110060/ginkgo-master/genomes/", genome, "/", pseudoautosomal, "/GC_", bm, sep=""), header=FALSE, sep="\t", as.is=TRUE)
#
bounds = read.table(paste("/lustre/home/2301110060/ginkgo-master/genomes/", genome, "/", pseudoautosomal, "/bounds_", bm, sep=""), header=FALSE, sep="\t")
