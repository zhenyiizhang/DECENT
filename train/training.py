...
def conv_onehot(seq):
    ...
    methy_mask = seq == 4
    onehot[methy_mask] = torch.tensor([0, 0, 1, 0, 1], dtype=torch.int64, device=device)
...
if __name__ == '__main__':
    train_dir = '/lustre/home/2301110060/NIPGT/data/zhenyi/header/train_file/result/' # directory to store the results and data
